...
const About = () => {
  return (
    <div className="mx-auto mb-auto" id="about">
      ...
      <p>If you'd like to see more of Morgan's work, you can see a portfolio (web development as well as artistic), by <a href="https://adoring-mclean-bb6d7c.netlify.app/" rel="noopener noreferrer" target="_blank">clicking here.</a></p>
    </div>
  );
}
